...
## Resource.get/3 has been changed

From now on we pass the `fields` to `Resource.get/3` explicitly. Therefore, the arity of this functions has changed to [`Resource.get/4`]().
