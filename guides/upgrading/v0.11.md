...
We are planning to remove the Alpine.js dependency and replace it with custom hooks. We are not done yet but a few
things got replaced already. In order to make them work, you now need to import these Backpex hooks into your JS bundle.
