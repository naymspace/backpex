defmodule Backpex.Ecto.EctoUtils do
  ...
  """
  def get_primary_key_field(%{ __struct__: struct }) when is_atom(struct) do # name of the schema module#
  # the typechecker will shout that an atom does not have a __schema__ attribute
    resolve_primary_key!(struct)
  end

  def get_primary_key_field(module) when is_atom(module) do # name of the schema module#
